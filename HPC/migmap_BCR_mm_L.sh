...
then
	...
	java -Xmx16G -jar /broad/ragon_compute/scripts/TCR_BCR_alignment/migmap-1.0.2/migmap-1.0.2.jar --blast-dir /broad/ragon_compute/scripts/igblast-bin/binaries/linux-x64 -R IGK,IGL -S mouse $id $outid
